  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-20 py-10">
      <motion.div
        ...
        className="bg-[#161513] rounded-2xl"
      >
        <h3 className="text-center font-guerrilla py-3">Tecnologías Basicas</h3>
      ...
      <motion.div
        ...
        className="bg-[#161513] rounded-2xl"
      >
        <h3 className="text-center font-guerrilla py-3">Tecnologías Mobile</h3>
        <ul className="grid grid-cols-4 pt-2 pb-4">
          <li className="flex flex-col gap-2 items-center justify-center text-5xl">
            <SiReact />
